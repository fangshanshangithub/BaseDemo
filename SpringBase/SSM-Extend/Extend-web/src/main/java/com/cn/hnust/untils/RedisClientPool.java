...
public class RedisClientPool {
	 ...
	 */
	 public static void init() {
		 ...
		 String host = PropertiesUtils.getProperty("", "redis.host");//"localhost";
		 int port = Integer.parseInt(PropertiesUtils.getProperty("", "redis.port"));//6379;
		 int timeout = Integer.parseInt(PropertiesUtils.getProperty("", "redis.timeout"));//60000;
		 // 构造连接池
